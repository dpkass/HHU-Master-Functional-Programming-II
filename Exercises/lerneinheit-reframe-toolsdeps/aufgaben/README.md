...
* [`src/cljs/reframe/aufgaben/`](src/cljs/reframe/aufgaben/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/reframe/aufgaben/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `aufgaben` project root directory
